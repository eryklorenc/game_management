...
import 'package:game_management/data/remote_data_sources/most_popular_remote_data_sources.dart'
    as _i5;
import 'package:game_management/features/auth/cubit/root_cubit.dart' as _i6;
...
import 'package:game_management/features/home/wish_list/cubit/wish_list_cubit.dart'
    as _i11;
import 'package:game_management/repositories/items_repository.dart' as _i7;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i5.MostPopularRemoteDataSource>(
        () => _i5.MostPopularRemoteDataSource());
    ...
    gh.factory<_i8.ItemsRepositoryMostPopular>(() =>
        _i8.ItemsRepositoryMostPopular(gh<_i5.MostPopularRemoteDataSource>()));
    gh.factory<_i9.LibraryPageCubit>(
        () => _i9.LibraryPageCubit(gh<_i7.ItemsRepository>()));
    gh.factory<_i10.MostPopularCubit>(
        () => _i10.MostPopularCubit(gh<_i8.ItemsRepositoryMostPopular>()));
    gh.factory<_i11.WishListCubit>(
        () => _i11.WishListCubit(gh<_i7.ItemsRepository>()));
    return this;
  }
}
